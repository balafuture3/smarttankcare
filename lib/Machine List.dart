            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                  new  Flexible(flex:1,child: Text("Machine Code",style: TextStyle(fontWeight:FontWeight.w900,color: Colors.white),)),
                  new  Flexible(flex:1,child: Text("Contract Date",style: TextStyle(fontWeight:FontWeight.w900,color: Colors.white),)),
                 new   Flexible(flex:2,child: Text("Machine Holder Name",style: TextStyle(fontWeight:FontWeight.w900,color: Colors.white),)),
                  ],
                ),
              ),
              Container(
