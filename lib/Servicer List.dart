            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text("Machine Name",style: TextStyle(fontWeight:FontWeight.w900,color: Colors.white),),
                    Text("Mobile No",style: TextStyle(fontWeight:FontWeight.w900,color: Colors.white),),
                    Text("                  Name",style: TextStyle(fontWeight:FontWeight.w900,color: Colors.white),),
                  ],
                ),
              ),
              Container(
